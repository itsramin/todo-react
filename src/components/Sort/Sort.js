...
const Sort = () => {
  ...
  const allDueHandler = () => {
    ctx.sort("all due date");
  };
  const allCreatHandler = () => {
    ctx.sort("all creation date");
  };
  const allAlphaHandler = () => {
    ctx.sort("all alphabet");
  };
  return (
    <div className={style["sort"]}>
      ...
      <ul className={style.sublist}>
        <div className={style["sublist-section"]}>
          <h4 className={style["sublist-header"]}>in this category</h4>
        ...
        <div className={style["sublist-section"]}>
          <h4 className={style["sublist-header"]}>in all categories</h4>
          <li className={style["sublist-item"]} onClick={allDueHandler}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <li className={style["sublist-item"]} onClick={allCreatHandler}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <li className={style["sublist-item"]} onClick={allAlphaHandler}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
